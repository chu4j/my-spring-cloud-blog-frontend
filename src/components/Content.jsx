                                            ...
                                            <Grid.Row>
                                                <Grid.Column width={5}>
                                                    ...
                                                    {a.category.map((c, index) =>
                                                        ...
                                                        <> <div key={index}><span><Icon name="linkify" color="blue" /><a href={"/category/" + c.category} style={{ fontWeight: '900' }}>{c.category}</a></span></div></>
                                                    )
                                                    }
                                                </Grid.Column>
                                                ...
                                                <Grid.Column width={11}>
                                                    {
                                                        a.tag.map((t, index) =>
                                                            <> <span key={index}><Icon name="hashtag" color="yellow" /><a href={"/tag/" + t.tag} style={{ fontWeight: '900' }}>{t.tag}</a></span></>
                                                        )
                                                    }
                                                </Grid.Column>
                                            </Grid.Row>
